package edu.hm.jaumann.View.Screens;
        ...
        Screen
{
    ...
    public void show()
    {
        Gdx.app.log( TheGame.LOG, "Showing screen: " + getName() );
    ...
    public void resize(
            ...
            int height )
    {
        Gdx.app.log( TheGame.LOG, "Resizing screen: " + getName() + " to: " + width + " x " + height );
    }
    ...
    public void hide()
    {
        Gdx.app.log( TheGame.LOG, "Hiding screen: " + getName() );
    ...
    public void pause()
    {
        Gdx.app.log( TheGame.LOG, "Pausing screen: " + getName() );
    }

    @Override
    public void resume()
    {
        Gdx.app.log( TheGame.LOG, "Resuming screen: " + getName() );
    }

    @Override
    public void dispose()
    {
        Gdx.app.log( TheGame.LOG, "Disposing screen: " + getName() );
